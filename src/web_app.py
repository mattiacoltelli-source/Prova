...
storico, grafici Reali vs Previsti e % di accuratezza per gli asset configurati.
"""
...
<body>
    ...
    <div class="grid-two-assets">
        {% for asset in data.assets_data.keys() %}
    ...
    <script>
        ...
        Object.keys(rawData.assets_data).forEach(asset => {
